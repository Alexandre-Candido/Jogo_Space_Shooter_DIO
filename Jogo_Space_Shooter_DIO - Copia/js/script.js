...
function movefundo() {	
    esquerda = parseInt($("#main-play-area").css("background-position"));
...
const aliensImg = ['imgs/monster1.png', 'imgs/monster2.png', 'imgs/monster3.png', 'imgs/monster4.png', 'imgs/monster5.png', 'imgs/monster6.png'];
